	...
	<div class="banner_top innerpage" id="home">
		<div class="wrapper_top_w3layouts">
			<div class="header_agileits">
				<div class="logo inner_page_log">
					<h1><a class="navbar-brand" href="index "><span>Nova</span> <i>Studio</i></a></h1>
				</div>
				<div class="overlay overlay-contentpush">
					...
					<nav>
						<ul>
							...
							<li><a href="<?php echo RUTA_URL; ?>/paginas/contact ">Contacto</a></li>
						</ul>
					</nav>
				</div>
		...
		<div class="services-breadcrumb_w3ls_agileinfo">
			<div class="inner_breadcrumb_agileits_w3">
				...
				<ul class="short">
					<li><a style="color: #2e2f2f;" href="<?php echo RUTA_URL; ?>/paginas/index ">Home</a><i>|</i></li>
					<li>¿Quienes Somos?</li>
				</ul>
			</div>
		</div>
