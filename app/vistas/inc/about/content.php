...
<div class="ads-grid_shop">
		<div class="shop_inner_inf">
			<h3 class="head">¿Que es Nova Studio?</h3>
			
			<div class="inner_section_w3ls">
				<div class="col-md-6 news-left">
					<img src="<?php echo RUTA_URL; ?>/images/ab.jpg" alt=" " class="img-responsive">
				</div>
	...
	<div class="mid_services">
		<div class="col-md-6 according_inner_grids">
			<h3 class="heading two">Nuestras Caracteristicas</h3>
		...
		<div class="col-md-6 mid_services_img">
			<div class="bar-grids">
				<h3 class="heading two three">Nuestras Habilidades</h3>
				<div class="skill_info">
					<h6>Desarrollo<span> 95% </span></h6>
					<div class="progress">
						<div class="progress-bar progress-bar-striped active" style="width: 95%">
						</div>
					</div>
					<h6>Precios<span> 85% </span></h6>
					<div class="progress">
						<div class="progress-bar progress-bar-striped active" style="width: 85%">
						</div>
					</div>
					<h6>Produccion<span>90% </span></h6>
					<div class="progress">
						<div class="progress-bar progress-bar-striped active" style="width: 90%">
						</div>
					</div>
					<h6>Atencion al cliente <span>86% </span></h6>
