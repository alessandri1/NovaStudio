	...
	<div class="banner_top innerpage" id="home">
				...
				<div class="overlay overlay-contentpush">
					...
					<nav>
						<ul>
							...
							<li><?php if($_SESSION['logged_user']->super_admin=="1") : ?>
        													<a href="./usuarios">Usuarios</a>
    									<?php endif; ?></li>
							<li><a href="./destroySession">Salir</a></li>
						</ul>
					</nav>
				</div>
		...
		<div class="services-breadcrumb_w3ls_agileinfo">
			<div class="inner_breadcrumb_agileits_w3">
				...
				<ul class="short">
					<li><a style="color: white;" href="<?php echo RUTA_URL; ?>/paginas/index ">Home</a><i>|</i></li>
					<li>Modulo Administrativo</li>
				</ul>
			</div>
		</div>
		<!-- //banner_inner -->
